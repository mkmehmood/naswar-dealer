...
const SCRIPT_INTEGRITY = {
  ...
  'https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js':
    'sha256-oFMSVFHzBbXFqdVkqA4LXhFgkHcakFhlJJVP5SLYLHY='
};
...
script.onerror = () => {
  // If SRI was set and it failed, retry without integrity (CDN hash mismatch fallback)
  if (sri) {
    const fallback = document.createElement('script');
    fallback.src = url;
    fallback.crossOrigin = 'anonymous';
    fallback.onload = () => resolve();
    fallback.onerror = () => reject(new Error(`Failed to load script: ${url}`));
...
if (!_chartJsPromise) {
_chartJsPromise = loadScript('https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js')
